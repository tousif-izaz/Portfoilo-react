...
<section id="aboutme" className="min-h-screen p-10 bg-white dark:bg-black text-black dark:text-white">
      <div className="max-w-4xl mx-auto p-6 border shadow-lg bg-gray-100 dark:bg-gray-900 rounded-lg">
        ...
        <div className="text-center mt-6">
          <a href="contact" className="inline-block px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition">
            Let's Collaborate
          </a>
        </div>
      </div>
